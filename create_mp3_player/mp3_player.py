...
root = Tk()
root.title("Ertan Music Player")
root.geometry("400x500+280+10")
root.configure(background="#333333")

mixer.init()
frameCnt = 30
frames = [PhotoImage(file="main3.gif", format="gif -index %i" %i) for i in range(frameCnt)]
...
image_icon = PhotoImage(file="e_logo.png")
...
Volume1 = PhotoImage(file="vol3.png")
